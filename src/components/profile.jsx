...
export default class Profile extends Component {
    render() {
        return <div className='flex-column-container profile'>
            <div>
                <img width="260" height="260" src="https://avatars0.githubusercontent.com/u/19260778?s=460&v=4" alt="Not supported" />
            </div>
            <div>
                <h1 class="vcard-names">
                    <span class="fullname" itemprop="name">Mano M</span>
                </h1>
            </div>
            <div className='username'>
                <h1 class="vcard-names">
                    <span class="username" itemprop="additionalName">VBIManonmaniM</span>
                </h1>
            </div>
            <div>
                <button name="button" type="button" class="editButton">
                    Edit profile
                </button>
            </div>
            <div className='org'>
